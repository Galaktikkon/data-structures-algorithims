...
# zagięciu (należące do S) i rozważamy drogi uzyskane przez skoki do tych planet. Jeśli wyciągamy wierzchołek "b", to zwracamy tablicę "d".
# Na końcu algorytmu korzystamy z tablicy d, która zawiera odległości od wierzchołka "a" i sprawdzamy 
# czy istnieje droga do "b", jeśli tak to ją zwracamy, inaczej zwracamy None.
